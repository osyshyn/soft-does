  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Data Analytics & Predictive Insights Solutions | SoftDoes",
        description:
          "SoftDoes provides advanced data analytics solutions, predictive analytics consulting, and real-time insights for smarter business decisions",
