  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Tech Insights & Software Development Articles | SoftDoes",
        description:
          "Explore SoftDoes’ tech thought leadership, software development articles, and data science insights to stay updated on the latest trends and best practices",
