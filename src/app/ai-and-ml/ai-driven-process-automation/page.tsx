...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: seo.aiAndMl.aiDPAuto.openGraph.title,
      description: seo.aiAndMl.aiDPAuto.openGraph.description,
      url: seo.aiAndMl.aiDPAuto.openGraph.url,
      images: seo.aiAndMl.aiDPAuto.openGraph.images,
      type: seo.aiAndMl.aiDPAuto.openGraph.type as "website",
    },
    twitter: {
      title: seo.aiAndMl.aiDPAuto.twitter.title,
      description: seo.aiAndMl.aiDPAuto.twitter.description,
      images: seo.aiAndMl.aiDPAuto.twitter.images,
    },
  };
}
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Intelligent Process Automation Solutions | SoftDoes",
        description:
          "SoftDoes offers AI-driven process automation services, streamlining workflows, reducing costs, and enhancing operational efficiency with intelligent solutions",
        ...
        mainEntity: {
          "@type": "Service",
          "@id":
            "https://softdoes.com/ai-and-ml/ai-driven-process-automation#service",
          name: "AI Driven Process Automation",
