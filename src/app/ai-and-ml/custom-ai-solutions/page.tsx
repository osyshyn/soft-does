  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Custom AI Solutions for Business Innovation | SoftDoes",
        description:
          "SoftDoes delivers custom AI solutions, designing intelligent systems tailored to your business needs, enhancing efficiency, and driving innovation",
        ...
        mainEntity: {
          "@type": "Service",
          "@id": "https://softdoes.com/ai-and-ml/custom-ai-solutions#service",
          name: "Custom AI Solutions",
