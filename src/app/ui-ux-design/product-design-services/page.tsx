  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Product Design Services for Web & Mobile | SoftDoes",
        description:
          "SoftDoes provides product design services, creating intuitive, user-focused interfaces and experiences for web and mobile applications that drive engagement",
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: "https://softdoes.com/ui-ux-design/product-design-services/",
            },
          ],
        },
        areaServed: ["US"],
        mainEntity: {
          "@type": "Service",
          "@id":
            "https://softdoes.com/ui-ux-design/product-design-services#service",
          name: "Product Design Services",
