  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "User-Centric UI/UX Design Solutions | SoftDoes",
        description:
          "SoftDoes delivers user-centric design solutions, creating intuitive, engaging, and visually appealing interfaces for web and mobile applications",
