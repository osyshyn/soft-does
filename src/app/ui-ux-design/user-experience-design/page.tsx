...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: seo.uiUxDesign.userED.openGraph.title,
      description: seo.uiUxDesign.userED.openGraph.description,
      url: seo.uiUxDesign.userED.openGraph.url,
      images: seo.uiUxDesign.userED.openGraph.images,
      type: seo.uiUxDesign.userED.openGraph.type as "website",
    },
    twitter: {
      title: seo.uiUxDesign.userED.twitter.title,
      description: seo.uiUxDesign.userED.twitter.description,
      images: seo.uiUxDesign.userED.twitter.images,
    },
  };
}
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "User & Customer Experience Design Services | SoftDoes",
        description:
          "SoftDoes offers user experience design, customer experience design, usability testing, and interaction design services to create intuitive and engaging apps",
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: "https://softdoes.com/ui-ux-design/user-experience-design/",
            },
          ],
        },
        areaServed: ["US"],
        mainEntity: {
          "@type": "Service",
          "@id":
            "https://softdoes.com/ui-ux-design/user-experience-design#service",
          name: "User Experience Design",
