  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Cloud Computing & Infrastructure Services | SoftDoes",
        description:
          "SoftDoes delivers cloud computing solutions, infrastructure management, multi-cloud services, and cloud strategy consulting as a leading cloud provider",
