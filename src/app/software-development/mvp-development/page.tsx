  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "MVP & Product Prototype Development Services | SoftDoes",
        description:
          "SoftDoes helps startups with MVP development and product prototype services, turning ideas into functional, testable solutions for early-stage validation",
        ...
        mainEntity: {
          "@type": "Service",
          "@id":
            "https://softdoes.com/software-development/mvp-development#service",
          name: "MVP Development",
