...
import { Hero } from "@sections/software-services/mobile-app-dev/hero/hero";
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Mobile App Development Services & Solutions | SoftDoes",
        description:
          "SoftDoes offers mobile app development services, enterprise mobile solutions, cross-platform and native apps, delivered by expert mobile app developers",
        ...
        mainEntity: {
          "@type": "Service",
          "@id":
            "https://softdoes.com/software-development/mobile-app-development#service",
          name: "Mobile App Development",
