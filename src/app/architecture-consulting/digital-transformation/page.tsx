...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        seo.architectureConsulting.digitalTransformation.openGraph.description,
      ...
      type: seo.architectureConsulting.digitalTransformation.openGraph
        .type as "website",
    },
    twitter: {
      title: seo.architectureConsulting.digitalTransformation.twitter.title,
      description:
        seo.architectureConsulting.digitalTransformation.twitter.description,
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "Digital Transformation Services | SoftDoes",
        description:
          "Custom digital transformation services including intelligent automation, intelligent chatbots, and intelligent workflows. SoftDoes delivers cutting-edge digital transformation services.",
