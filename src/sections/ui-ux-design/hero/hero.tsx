...
import hero from "@assets/images/uiux/heroObject.png";
  ...
  return (
    <section className={s.root}>
      <div className={s.container}>
        <Kansas />
        <h1 className={s.title}>UI/UX Design</h1>
        <p className={s.tagText}>Designs that captivate, experiences that deliver.</p>
