...
import { User } from "@assets/icons/services/uiux/icons";
import { Interface } from "@assets/icons/services/uiux/icons";
import { Light } from "@assets/icons/services/uiux/icons";
...
export default function Uiux() {
  return (
    <>
      <SEO title="SOFT DOES" description="SOFT DOES is company, that will help your bussines grow!" pathname={ROUTES.uiux_design} />
      <Layout>
        <Hero />
        <Results />
        <Technologies />
